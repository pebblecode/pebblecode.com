...
define("jquery.isotope", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.jQuery.fn.isotope;
    };
}(this)));

/**
 * Extension for isotope to center masonry layout
 *
 * See:
 * http://isotope.metafizzy.co/docs/layout-modes.html
 * http://isotope.metafizzy.co/custom-layout-modes/centered-masonry.html
 */
define('jquery.isotope.center',[
  "jquery",
  "jquery.isotope"
], function($, isotope) {
